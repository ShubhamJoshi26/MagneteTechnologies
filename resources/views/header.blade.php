...
<html lang="en-US">
   <head>
      ...
      <title>Magnete Technologies</title>
      <link rel="icon" type="image/png" sizes="32x32" href="{{URL::asset('admin/images/magnetetechnologies-logo.png')}}">
      ...
      <link rel="stylesheet" href="{{URL::asset('admin/assets/css/jquery.animatedheadline.css')}}">
      <link rel="stylesheet" href="{{URL::asset('admin/assets/css/magnific-popup.css')}}">
      <link rel="stylesheet" href="{{URL::asset('admin/assets/css/owl.carousel.min.css')}}">
      <link rel="stylesheet" href="{{URL::asset('admin/assets/css/owl.theme.default.min.css')}}">
      <link rel="stylesheet" href="{{URL::asset('admin/assets/css/style.css')}}">
      <link rel="stylesheet" href="{{URL::asset('admin/assets/css/responsive.css')}}">
   </head>
   <body>
      <div id="preloader">
         <div class="spinner">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
         <div class="container">
            ...
            <img src="{{URL::asset('admin/images/magnetetechnologies-logo.png')}}" alt="" />
            </a>
